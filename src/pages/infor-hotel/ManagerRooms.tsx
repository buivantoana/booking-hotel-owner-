...
import { Box, Button, Chip, Menu, MenuItem, Paper, Stack, Table, TableBody, TableCell, TableContainer, TableHead, TableRow } from '@mui/material'
import React, { useState } from 'react'
import RoomDetail from './RoomDetail'

type Props = {}

const ManagerRooms = (props: Props) => {
  return (
    <>
