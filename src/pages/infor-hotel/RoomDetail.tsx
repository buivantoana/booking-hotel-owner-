    ...
    <Box sx={{ p: 2,  minHeight: "100vh" }}>
       <Dialog
            ...
            <DialogContent sx={{ textAlign: "center", px: 4, pb: 3 }}>
              ...
              Khách sẽ không thể đặt phòng này sau khi bạn ngừng kinh doanh loại phòng. Bạn có thể mở kinh doanh lại loại phòng trong tương lai.
      ...
      <Box sx={{ display: "flex", alignItems: "center", mb: 3 }}>
        <KeyboardArrowLeftIcon sx={{ fontSize: 30, mr: 1 }} />
        <Box>
